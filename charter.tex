...
\begin{enumerate}
 	\item Como usuario, quiero acceder a la interfaz web mediante un usuario y una contraseña establecida previamente para garantizar la seguridad del sistema.
	...
	\item Como usuario, quiero configurar los datos de identificación de cada nodo para asignar nombres personalizados y roles dentro de la red. \textit{Story points}: 5 (relevancia: 0, dificultad: 3, incertidumbre: 2)
