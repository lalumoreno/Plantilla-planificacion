...
2      & Se refina el contexto del proyecto en el punto 1 \newline
...
La figura \ref{fig:diagBloquesBleMesh} ilustra el principio de comunicación en la red Bluetooth Mesh a implementar en este proyecto, donde los nodos, que en este caso corresponden a los sensores y actuadores en el invernadero, colaboran para transmitir los datos recopilados de manera eficiente hasta llegar al nodo central. La diferencia entre un nodo y un nodo central radica principalmente en la configuración asignada a cada dispositivo durante la instalación de la red.
...
\item Capacidad de asignar roles a los nodos (sensor o actuador) desde la interfaz web del nodo central.
\item Soporte para la integración de nuevos sensores y actuadores dentro de la red sin necesidad de modificar la infraestructura existente.
\item Simulación de datos en los microcontroladores ESP32-C3 adquiridos para el proyecto, en lugar de utilizar los dispositivos reales de la empresa.
...
\item Requerimientos Funcionales
	\begin{enumerate}
		...
		\item El nodo central debe recopilar y almacenar la información de todos los sensores.
		\item El servidor web embebido en el nodo central debe permitir la visualización de los datos en tiempo real.
		\item La configuración de la red debe ser posible a través de la interfaz web.
		\item La comunicación entre los nodos debe ser tolerante a fallos, permitiendo la reorganización automática de la red en caso de pérdida de un nodo.
		\item Los sensores deben poder ser agregados o eliminados dinámicamente de la red.
	\end{enumerate}

\item Requerimientos de Documentación
	\begin{enumerate}
		\item Manual de usuario para la configuración y monitoreo de la red a través de la interfaz web.
		\item Documentación técnica del firmware desarrollado, incluyendo estructura de código y diagramas de flujo.
		\item Especificación de los protocolos de comunicación utilizados.
		\item Instructivo de instalación y despliegue del sistema en los dispositivos de {\empclientename}.
		\item Registro de pruebas realizadas, con casos de prueba y resultados.
	\end{enumerate}

\item Requerimientos de Testing
	\begin{enumerate}
		\item Validación de la conectividad y estabilidad de la red Bluethooth Mesh con un minomo de cuatro nodos.
		\item Pruebas de latencia y pérdida de paquetes en diferentes condiciones ambientales.
%		\item Evaluación del consumo energético de los nodos en diferentes escenarios de uso.
		\item Simulación de fallos en nodos individuales para verificar la capacidad de recuperación de la red.
		\item Pruebas de carga en el servidor web para garantizar su rendimiento con múltiples conexiones simultáneas.
	\end{enumerate}

\item Requerimientos de Interfaz
	\begin{enumerate}
		\item La interfaz web debe ser accesible desde dispositivos móviles y de escritorio.
		\item Debe ofrecer una visualización gráfica de los sensores y sus valores en tiempo real.
		\item Debe permitir configurar parámetros básicos de la red, como frecuencia de transmisión de datos y nodos activos.
La interfaz debe ser intuitiva y de fácil navegación para el usuario final.
		\item Debe contar con autenticación básica para restringir el acceso a la configuración del sistema.
	\end{enumerate}

\item Requerimientos de Desempeño
	\begin{enumerate}
		\item El sistema debe ser capaz de operar con al menos 4 sensores en simultáneo.
%		\item La latencia máxima permitida en la transmisión de datos entre un nodo y el nodo central debe ser inferior a Y ms.
		\item El nodo central debe manejar la concurrencia de múltiples usuarios sin degradación significativa del rendimiento.
	\end{enumerate}

\item Requerimientos de Seguridad
	\begin{enumerate}
%		\item La comunicación entre los nodos debe estar cifrada para evitar accesos no autorizados.
		\item El servidor web embebido debe contar con mecanismos de autenticación para restringir cambios en la configuración.
		\item Debe implementarse validación de datos para evitar ataques como inyección de comandos.
	\end{enumerate}

\item Requerimientos de Hardware y Compatibilidad
	\begin{enumerate}
		\item El firmware debe ser compatible con los microcontroladores ESP32-C3.
		\item La solución debe ser compatible con futuras expansiones de la red sin modificaciones significativas en el código
	\end{enumerate}
